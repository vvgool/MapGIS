...
public final class GeoUtils {
    ...
    protected static int mTileSize = MapConstants.TILE_SIZE;
     ...
     */
    private static int mMaxZoomLevel = MapConstants.MAX_ZOOM;
    ...
    public static Point PixelXYToOffsetXY(final int pixelX, final int pixelY, final Point reuse) {
        final Point out = (reuse == null ? new Point() : reuse);
        out.x = pixelX % mTileSize;
        out.y = pixelY % mTileSize;
        return out;
